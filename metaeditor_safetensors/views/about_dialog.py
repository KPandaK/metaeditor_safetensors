...
class AboutDialog(QDialog):
    ...
    def _setup_clickable_links(self):
        ...
        self.ui.kofiLink.setToolTip("If you like this, consider buying me a coffee on Ko-fi!")
    ...
    def _open_github_link(self, event):
        ...
        if event.button() == Qt.LeftButton:
            QDesktopServices.openUrl(QUrl("https://github.com/KPandaK/metaeditor_safetensors"))
